/*  Prototype.Symulate, version 0.0.1
 *  (c) 2009 FIXME full name
 *
 *  Prototype.Symulate is freely distributable under
...
;(function(e) {
	e.addMethods({
		simulate: function(element, type, options){
			return (function(){
				var opt = Object.extend(options, e.simulate.defaults);
				new Simulate(element, type, opt);
			})(type, options);
		}
	});
...
Element.simulate.Version = '0.0.1';